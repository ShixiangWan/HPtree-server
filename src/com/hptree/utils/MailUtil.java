...
public class MailUtil {
	...
	public void send(String email, String attachpath) throws MessagingException, UnsupportedEncodingException {
		...
		final String apiUser = "shixiang_test_iBd0Bd";
		final String apiKey = "rO5BmqicKnynMbbz";
		...
		// 发信人
		message.setFrom(new InternetAddress("HPtree_Org@fX57ZQc5Ez3A8paY55Bmd5yDlHsUuLkJ.sendcloud.org", "HPtree", "UTF-8"));
		// 收件人地址
		message.addRecipient(RecipientType.TO, new InternetAddress(to));
		// 邮件主题
		message.setSubject("HPtree Expriment", "UTF-8");

		Multipart multipart = new MimeMultipart("hptree_results");

		// 添加html形式的邮件正文
		String html = "Hello! </br>"
				+ "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Your HPtree experiment has been completed successfully, and the result file is in the attachment.</br>"
	            + "Best regards,<br/>"
	            + "Shixiang Wan";
